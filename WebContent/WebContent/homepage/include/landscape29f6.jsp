...
<p><span style="font-size:12.0pt"><span style="font-family:나눔스퀘어라운드 Regular"><span style="color:#595959">시원한 블루포인트의 옹달샘 펜션으로 당신을 초대합니다</span></span></span><span style="font-size:12.0pt"><span style="font-family:나눔스퀘어라운드 Regular"><span style="color:#595959">.</span></span></span></p>
				</div>
			</div>
		</div>
	</div>
		...
		<div class="about3_wrap">
			...
			<div class="about3_bottom">
				...
				<div class="about3_logo">
					<img src="../../img.einet.kr/P202011017/logo/logo_img.png" id="landscape-logo">
				</div>
			</div>
	...
	<div class="cpage about4" id="about4">
		<div class="about4_wrap clearfix">
			<div class="about4_slogan">
				<h5>Map & Location</h5>
				<p class="txt">행복 가득한 옹달샘 펜션으로 오시는 길</p>
			</div>
