...
<!-- Mirrored from www.marineblue.kr/include/room.php&menutree_idx=41596 by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 27 Oct 2021 03:05:17 GMT -->
<head>
<meta charset="utf-8">
...
var menutree_idx = '41596';
</script>

<link type="text/css" rel="stylesheet" href="rspn01/P202011017/css/room72a6.css?v=1614732143"/>
<script src="rspn01/P202011017/jscript/room72a6.js?v=1614732143"></script>
...
<a class="page" href="landscape2.jsp?biz_code=P202011017&amp;tab=about4">오시는 길</a>
				...
				<li class="room-big-menu">
					...
					<dl class="sub">
						...
						<a class="page" data-idx="41596" href="room3.jsp">201꿀금고</a></dt>
					</dl>
				</li>
				<li class="fac-big-menu">
					...
					<dl class="sub">
						<dt>
													...
													<a class="page" data-idx="41613" href="travel1.jsp">관광지1</a>
			...
			<div class="gnb_menu_mobile_inner">
                ...
                <ul class="menuList">
                    ...
                    <!-- 서비스 -->
                        ...
                        <ul class="subMenuList">
                                                                            <li class="page" data-idx="41613"><a href="travel1.jsp">관광지1</a></li>
                                                    <li class="page" data-idx="41614"><a href="travel2.jsp">관광지2</a></li>
                                                    <li class="page" data-idx="41615"><a href="travel3.jsp">관광지3</a></li>

                                                    <li class="page" data-idx="41620"><a href="travel7bc5.jsp&amp;menutree_idx=41620">주변맛집</a></li>
                                                </ul>
                    </li>
                    <li class="menuTitle">
				...
				<ul class="mobile_menu_sub" id="pos-container">
					...
					<li class="fac-small-menu">
						...
						<ul>
													...
													<li class="page" data-idx="41613"><a href="/include/travel.php&menutree_idx=41613">관광지1</a></li>
	...
	<div class="cpage room3" id="room3">
		<div class="firstSlider" id="firstSlider">
			<div class="main-slides owl-carousel">	
				<p style="width:100%; height:100%; background:url('../../img.einet.kr/P202011017/room/41596/0172a6.jpg?v=1614732143') no-repeat center center; background-size:cover; "></p><p style="width:100%; height:100%; background:url('../../img.einet.kr/P202011017/room/41596/0272a6.jpg?v=1614732143') no-repeat center center; background-size:cover; "></p><p style="width:100%; height:100%; background:url('../../img.einet.kr/P202011017/room/41596/0372a6.jpg?v=1614732143') no-repeat center center; background-size:cover; "></p><p style="width:100%; height:100%; background:url('../../img.einet.kr/P202011017/room/41596/0472a6.jpg?v=1614732143') no-repeat center center; background-size:cover; "></p><p style="width:100%; height:100%; background:url('../../img.einet.kr/P202011017/room/41596/0572a6.jpg?v=1614732143') no-repeat center center; background-size:cover; "></p><p style="width:100%; height:100%; background:url('../../img.einet.kr/P202011017/room/41596/0672a6.jpg?v=1614732143') no-repeat center center; background-size:cover; "></p><p style="width:100%; height:100%; background:url('../../img.einet.kr/P202011017/room/41596/0772a6.jpg?v=1614732143') no-repeat center center; background-size:cover; "></p><p style="width:100%; height:100%; background:url('../../img.einet.kr/P202011017/room/41596/0872a6.jpg?v=1614732143') no-repeat center center; background-size:cover; "></p><p style="width:100%; height:100%; background:url('../../img.einet.kr/P202011017/room/41596/0972a6.jpg?v=1614732143') no-repeat center center; background-size:cover; "></p><p style="width:100%; height:100%; background:url('../../img.einet.kr/P202011017/room/41596/1072a6.jpg?v=1614732143') no-repeat center center; background-size:cover; "></p><p style="width:100%; height:100%; background:url('../../img.einet.kr/P202011017/room/41596/1172a6.jpg?v=1614732143') no-repeat center center; background-size:cover; "></p>			</div>
			<div class="viewObj">
			...
			<div class="room_info_wrap">
				...
				<div class="room_info">
					<dl>
						...
						<dd><span>&bullet; 형태/유형</span>객실 + 거실, 온돌, 침대, 별채, 테라스 / 커플, 가족</dd>
											<dd><span>&bullet; 특이사항</span>블루와 화이트의 시원한 객실<br>커플 가족 룸 아일랜드 홈바와 실내 스파, 테라스 비비큐</dd>
										    <dd><span>&bullet; 입실시간</span></dd>
						<dd><span>&bullet; 퇴실시간</span>11</dd>
					</dl>

					<dl>
						<dd><span class="infoB">구비시설</span>대형스파, Qook TV, Wifi, 침대[호텔침구], 에어컨, 소파, 주방집기(2인), 화장실 1개, 고대기, 전자렌지, 전기압력밭솥, 타올, 휴지, 샴푸/바디워시, 전기그릴, 드라이기, 전기포트, 냄비, 후라이팬,치약, 칫솔</dd>
					</dl>
					...
					<dl>
						...
						<dd><span>&bullet; 성수기</span>2021-07-25 ~ 2021-08-15</dd>
					</dl>
					...
					<dl>
						...
						<dd><span>&bullet; 기준인원</span>2명 / 최대인원 : 2명
													...
													<p>초과금액 : 중학생 이상 20,000원 초등학생 10,000원 미취학 아동 없음</p>
				...
				<div class="room_reserve">
					<a href="/include/booking.php"><i class="fal fa-history"></i>실시간 예약하기</a>
				</div>
			</div>
		</div>
	</div>
	...
	<div class="cpage room4" id="room4">
		<div class="room4_wrap">
            ...
            <div class="room_title_second">
                <span style="margin-right:20px; ">102꿀단지</span>
                <span style="color:#ddd; "></span>
            </div>
									<iframe src="iframe/ddnayo_room_price2410.jsp&amp;booking_id=2161&amp;room_no=17016&amp;room_name=102%eb%82%98%eb%9e%98&amp;limit_man=2&amp;max_man=2" width="100%" height="400" frameborder="0" marginwidth="0" marginheight="0" style="-ms-overflow-x: hidden; -ms-overflow-y: scroll;" allowtransparency="true" topmargin="0"></iframe>
					<!--            <div class="room_reserve slide-info__reserve">
                <a href="/include/booking.php?biz_code=" class="component button" id="btn-booking" data-sel="id"><i class="fal fa-history"></i>실시간 예약하기</a>
            </div>
-->
            <!--
			<div class="room4_other">
				<a href="/include/rooms.php">다른객실보기<i class="fal fa-chevron-right"></i></a>
			</div>
			-->
            ...
            <div class="cpage room2 slide-info" id="room2">
                <div class="room_reserve slide-info__reserve">
                    <a href="booking.jsp" class="component button" id="btn-booking" data-sel="id"><i class="fal fa-history"></i>실시간 예약하기</a>
                </div>
                            ...
                            <div class="hide-thing js-hide">
                                <dl class="slide-info__dl ">
                                    <!--						<dt>객실상세정보</dt>-->
                                                                        ...
                                                                        <dd><span>&bullet; 유형/형태</span>객실 + 거실, 온돌, 침대, 별채, 테라스 / 커플, 가족</dd>
                                                                            <dd><span>&bullet; 특이사항</span>블루와 화이트의 시원한 객실<br>커플 가족 룸 아일랜드 홈바와 실내 스파, 테라스 비비큐</dd>
                                                                            <!--dd><span>&bullet; 입실시간</span></dd>
						<dd><span>&bullet; 퇴실시간</span>11</dd-->
                                </dl>
	...
	<div class="cpage room1" id="room1">
		<img src="../../img.einet.kr/P202011017/room/41596/deco02.jpg" width="100%" />
	</div>
...
<div class="cpage room5" id="room5">
		...
		<div class="room_title">
			...
			<p class="txt TRAN">모던한 인테리어와 힐링 가득한 노천탕. 당신을 위해 준비하였습니다.</p>
			<a class="btn_rooms" href="roommain.jsp">VIEW ALL ROOMS <i class="fal fa-chevron-right"></i></a>
		</div>
			...
			<div class="itemList_wrap clearfix">
				<div class="swiper-container room-swiper on">
					<div class="swiper-wrapper" id="swiper-wrapper">
													...
													<a class="swiper-slide" href="room1.jsp">
								<div class="imgWrap">
									<div class="loader" style="background-image:url('../../img.einet.kr/P202011017/room/41595/00.jpg')"></div>
								</div>
								<div class="eng">101옹달샘</div>
								<div class="txt">2/2인&nbsp;<span>커플, 가족</span> </div>
								<span class="detailview">DETAIL VIEW<i class="fal fa-chevron-right"></i></span>
							</a>
													<a class="swiper-slide" href="room2.jsp">
								<div class="imgWrap">
									<div class="loader" style="background-image:url('../../img.einet.kr/P202011017/room/41596/00.jpg')"></div>
								</div>
								<div class="eng">102꿀단지</div>
								<div class="txt">2/2인&nbsp;<span>커플, 가족</span> </div>
								<span class="detailview">DETAIL VIEW<i class="fal fa-chevron-right"></i></span>
							</a>
													<a class="swiper-slide" href="room3.jsp">
								<div class="imgWrap">
									<div class="loader" style="background-image:url('../../img.einet.kr/P202011017/room/41597/00.jpg')"></div>
								</div>
								<div class="eng">201꿀금고</div>
								<div class="txt">2/2인&nbsp;<span>커플</span> </div>
								<span class="detailview">DETAIL VIEW<i class="fal fa-chevron-right"></i></span>
							</a>
...
<!--
	<div id="section5" class="cpage section5">
		<div class="room_title">
			...
			<a class="btn_rooms" href="/include/rooms.php">VIEW ALL ROOMS <i class="fal fa-chevron-right"></i></a>
		</div>

		<div class="roomList_wrap clearfix">
			<div class="swiper-container room-swiper">
				<div class="swiper-wrapper">
										<a class="swiper-slide" href="/include/room.php&menutree_idx=41595">
								<div class="imgWrap">
									<div class="loader" style="background-image:url('http://img.einet.kr/P202011017/room/41595/00.jpg')"></div>
								</div>
								<div class="eng">101옹달샘</div>
								<div class="txt">2/2인&nbsp;<span>커플, 가족</span> </div>
								<span class="detailview">DETAIL VIEW<i class="fal fa-chevron-right"></i></span>
							</a>
													<a class="swiper-slide" href="/include/room.php&menutree_idx=41596">
								<div class="imgWrap">
									<div class="loader" style="background-image:url('http://img.einet.kr/P202011017/room/41596/00.jpg')"></div>
								</div>
								<div class="eng">102꿀단지</div>
								<div class="txt">2/2인&nbsp;<span>커플, 가족</span> </div>
								<span class="detailview">DETAIL VIEW<i class="fal fa-chevron-right"></i></span>
							</a>
													<a class="swiper-slide" href="/include/room.php&menutree_idx=41597">
								<div class="imgWrap">
									<div class="loader" style="background-image:url('http://img.einet.kr/P202011017/room/41597/00.jpg')"></div>
								</div>
								<div class="eng">201꿀금고</div>
								<div class="txt">2/2인&nbsp;<span>커플</span> </div>
								<span class="detailview">DETAIL VIEW<i class="fal fa-chevron-right"></i></span>
							</a>
													<a class="swiper-slide" href="/include/room.php&menutree_idx=41598">
								<div class="imgWrap">
									<div class="loader" style="background-image:url('http://img.einet.kr/P202011017/room/41598/00.jpg')"></div>
								</div>
								<div class="eng">202라온</div>
								<div class="txt">2/2인&nbsp;<span>커플</span> </div>
								<span class="detailview">DETAIL VIEW<i class="fal fa-chevron-right"></i></span>
							</a>
													<a class="swiper-slide" href="/include/room.php&menutree_idx=41599">
								<div class="imgWrap">
									<div class="loader" style="background-image:url('http://img.einet.kr/P202011017/room/41599/00.jpg')"></div>
								</div>
								<div class="eng">203마루</div>
								<div class="txt">2/2인&nbsp;<span>커플</span> </div>
								<span class="detailview">DETAIL VIEW<i class="fal fa-chevron-right"></i></span>
							</a>
													<a class="swiper-slide" href="/include/room.php&menutree_idx=41600">
								<div class="imgWrap">
									<div class="loader" style="background-image:url('http://img.einet.kr/P202011017/room/41600/00.jpg')"></div>
								</div>
								<div class="eng">301보람</div>
								<div class="txt">2/2인&nbsp;<span>커플, 가족</span> </div>
								<span class="detailview">DETAIL VIEW<i class="fal fa-chevron-right"></i></span>
							</a>
													<a class="swiper-slide" href="/include/room.php&menutree_idx=41601">
								<div class="imgWrap">
									<div class="loader" style="background-image:url('http://img.einet.kr/P202011017/room/41601/00.jpg')"></div>
								</div>
								<div class="eng">302소원</div>
								<div class="txt">2/2인&nbsp;<span>커플, 가족</span> </div>
								<span class="detailview">DETAIL VIEW<i class="fal fa-chevron-right"></i></span>
							</a>
	...
	<div class="footer_info clearfix">
		<div class="info_left">
			<ul>
				...
				<li><span>계좌</span>지리산금고 000-000-00000</li>
...
<!-- Mirrored from www.marineblue.kr/include/room.php&menutree_idx=41596 by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 27 Oct 2021 03:10:26 GMT -->
</html>
