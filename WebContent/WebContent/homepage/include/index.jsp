	...
	<body>
		<div class="wrapper">
				<video autoplay muted loop >
					<source src="video/Waves - 70796.mp4"=type="video/mp4">
        ...
        <nav class="nav">
            <div>
                ...
                <div class="nav__brand">
                    ...
                    <a href="#" class="nav__logo">honey bear</a>
                </div>
                <div class="nav__list">
                    ...
                    <div href="roommain.jsp" class="nav__link collapse">
                        <ion-icon name="folder-outline" class="nav__icon"></ion-icon>
                        <span class="nav_name">ROOM</span>

                        <ion-icon name="chevron-down-outline" class="collapse__link"></ion-icon>

						<ul class="collapse__menu">
							<a href="room1.jsp" class="collapse__sublink">101옹달샘</a><br>
							<a href="room2.jsp" class="collapse__sublink">102꿀단지</a><br>
							<a href="room3.jsp" class="collapse__sublink">201꿀금고</a><br>
                        </ul>
                    </div>

                    <a href="facmain.jsp" class="nav__link">
                        <ion-icon name="pie-chart-outline" class="nav__icon"></ion-icon>
                        <span class="nav_name">FACILITIES</span>
                    </a><br><br>

                    <div href="servicemain.jsp" class="nav__link collapse">
                        ...
                        <ul class="collapse__menu">
                            <a href="service1.jsp" class="collapse__sublink">와인</a><br>
                            <a href="service2.jsp" class="collapse__sublink">전기그릴</a><br>
                            <a href="service3.jsp" class="collapse__sublink">디저트</a><br>
                        </ul>
                    </div>
					...
					<div href="#" class="nav__link collapse">
                        <ion-icon name="people-outline" class="nav__icon"></ion-icon>
                        <span class="nav_name">TRAVEL</span>

                        <ion-icon name="chevron-down-outline" class="collapse__link"></ion-icon>

                        <ul class="collapse__menu">
                            <a href="travel1.jsp" class="collapse__sublink">수목원</a><br>
                            <a href="travel2.jsp" class="collapse__sublink">관광지2</a><br>
                            <a href="travel3.jsp" class="collapse__sublink">관광지3</a><br>
                        </ul>
                    </div>
					...
					<div href="#" class="nav__link collapse">
                        ...
                        <ul class="collapse__menu">
                            <a href="#" class="collapse__sublink">실시간예약</a><br>
                            <a href="#" class="collapse__sublink">요금가이드</a><br>
                        </ul>
                    </div>
					...
					<div href="#" class="nav__link collapse">
                        ...
                        <ul class="collapse__menu">
                            <a href="community1.jsp" class="collapse__sublink">공지사항</a><br>
                            <a href="community2.jsp" class="collapse__sublink">FAQ</a><br>
                            <a href="community3.jsp" class="collapse__sublink">스케줄</a><br>
							<a href="#" class="collapse__sublink">예약확인</a>
				...
				<li class="comm-big-menu">
					...
					<dl class="sub">
						<dt>
									...
									<a class="page" data-idx="25446" href="community2.jsp">스케줄</a>
									<a class="page" data-idx="25447" href="community3.jsp">이용후기</a>
												</dt>
					</dl>
				</li>
			</ul>
			...
			<div class="gnb_menu_mobile_inner">
                ...
                <ul class="menuList">
                    ...
                    <li class="menuTitle">
						...
						<li data-idx="41597" style="margin-top:7px;"><a href="room2.jsp">201꿀금고</a></li>
