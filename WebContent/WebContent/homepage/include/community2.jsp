...
<link type="text/css" rel="stylesheet" href="rspn01/P202011017/css/community65df.css"/>
<script src="rspn01/P202011017/jscript/community65df.js"></script>
...
<dt>
			...
			<div class="gnb_menu_mobile_inner">
                ...
                <ul class="menuList">
                    ...
                    <!-- 서비스 -->
                        ...
                        <ul class="subMenuList">
							<li class="page" data-idx="41613"><a href="include/travel1.jsp">수목원</a></li>
							<li class="page" data-idx="41614"><a href="include/travel2.jsp">관광지2</a></li>
							<li class="page" data-idx="41615"><a href="include/travel3.jsp">관광지3</a></li>
                                                </ul>
                    </li>
                    <li class="menuTitle">
		...
		<div class="comm1_wrap">
			<div class="loader"style="background-image:url('../../img.einet.kr/P202011017/title/03.jpg');">
			</div>
	...
	<div class="cpage comm2" id="comm2">
		<div class="comm2_wrap">
						<a class="tab" data-idx="25444" data-type="NOTICE" style="cursor:pointer;" href="communitymain.jsp">공지사항</a>
						<a class="tab" data-idx="25445" data-type="FAQ" style="cursor:pointer;" href="community1.jsp">FAQ</a>
						<a class="tab" data-idx="25447" data-type="NORMAL" style="cursor:pointer;" href="community3.jsp">이용후기</a>
						<a class="tab" data-idx="25446" data-type="NORMAL" style="cursor:pointer;" href="community2.jsp">스케줄</a>
					</div>
	</div>
...
<div class="footer">
	...
	<div class="footer_info clearfix">
		<div class="info_left">
			<ul>
				<li><span>상호</span>지리산 옹달샘펜션</li>
				<li>
					<span>예약전화</span>
					<div id="contact-phone" style="display:inline-block">
						<span style='margin-right:10px'><a href='tel:000-0000-0000'>000-0000-0000</a></span>
					</div>
				</li>

								<li><span>주소</span>지리산</li>
				
								<li id="db-bank_info"><span>계좌</span>
					<div id="bank-info" style="display:inline-block; line-height:1.3em;">
						지리산금고 0000-0000-0000-0<br /> <br />
					</div>
				</li>
		...
		<div class="info_right">
			<ul>
									<li><span>사업자등록번호</span><caption id="db-biz_no"> 000-00-00000</caption></li>									<li><span>대표자</span><caption id="db-owner_name">반달곰</caption></li>
	...
	<a class="fixedBooking" href="booking.jsp">
		<i class="far fa-calendar-alt"></i>
	</a>

	<a class="fixedPhone" href="tel:000-0000-0000">
