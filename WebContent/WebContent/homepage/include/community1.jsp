...
<a class="page" data-idx="41595" href="room1.jsp">101옹달샘</a>
				...
				<li class="fac-big-menu">
					...
					<dl class="sub">
						<dt>
							<a class="page" data-idx="41613" href="include/travel1.jsp">수목원</a>
							<a class="page" data-idx="41614" href="include/travel2.jsp">관광지2</a>
							<a class="page" data-idx="41615" href="include/travel3.jsp">관광지3</a>
												</dt>
					</dl>
				</li>
...
<body>
    <div class="board_wrap">
        ...
        <div class="board_list_wrap">
            ...
            <div class="bt_wrap">
                <a href="write3.jsp" class="on">등록</a>
                <!--<a href="#">수정</a>-->
            </div>
        </div>
    </div>
