...
<!-- Mirrored from www.marineblue.kr/include/travel.php&menutree_idx=41614 by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 27 Oct 2021 03:47:58 GMT -->
<head>
<meta charset="utf-8">
...
<img src='../../img.einet.kr/P202011017/travel/41614/01e1a9.jpg?v=1614732861' width='100%' />
</div>
		...
		<div class="swiper-container serviceList">
			<div class="swiper-wrapper">
							...
							<div class="slogan"><span>관광지1</span></div>
										...
										<div data-idx="41614" class="swiper-slide active">
	...
	<div class="travel3_wrap">
		<div class="travel_info">
			...
			<div class="contents">
				<p>본 휴양림은 인공림과 천연림인 소나무와 참나무 숲이 조화롭게 어우러져있고,</p>
				<p>울창한 산림속에서 산림욕장, 숲속의 집, 강당 및 운동장,</p>
				<p>야외 물놀이터, 구내식당 등의 편의시설을 갖추어  </p>
				<p>단체 연수 및 친목회, 야유회 행사를 진행할 수 있는</p>
				<p>가족휴양지입니다.</p>  
				</div>
		</div>
	</div>
